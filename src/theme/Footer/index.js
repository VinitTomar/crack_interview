  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.inner}>
        <p className={styles.tagline}>Prep smarter, not harder.</p>
        <a
          href="https://github.com/VinitTomar/crack_interview/tree/main"
          target="_blank"
        ...
        <p className={styles.copyright}>© 2026 BuzzInterview</p>
      </div>
    </footer>
  );
}
